...
public class RegistroActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtContraseña.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String pass=txtContraseña.getText().toString();
                String passrpt=txtContraseñaRepetida.getText().toString();
                if(pass.length()==0){
                    Toast.makeText(RegistroActivity.this, "Minimo 6 Caracteres",Toast.LENGTH_SHORT).show();
                }
            }
        });
